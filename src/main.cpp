...
{    
    ...
    std::cout << "Please enter the value of start_x (0-100): "; 
    std::cin >> start_x;
    start_x = (start_x <0) ? 0: ((start_x > 100) ? 100 : start_x );

    std::cout << "Please enter the value of start_y (0-100): "; 
    std::cin >> start_y;
    start_y = (start_y <0) ? 0: ((start_y > 100) ? 100 : start_y );

    std::cout << "Please enter the value of end_x (0-100): "; 
    std::cin >> end_x;
    end_x = (end_x <0) ? 0: ((end_x > 100) ? 100 : end_x );

    std::cout << "Please enter the value of end_y (0-100): "; 
    std::cin >> end_y;
